            ...
            <div class="col-10 text-center">
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <form class="d-flex m-0 col-3" method="post">
                        <input class="form-control me-2" type="text" placeholder="Search name" aria-label="Search" name="searchCustomer">
                        <button class="btn btn-outline-success" type="submit" name="searchCustomer">Search</button>
                    </form>
                </div>
            </div>
        </div>

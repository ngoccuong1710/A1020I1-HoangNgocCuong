            ...
            <div class="col-10 text-center">
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <form class="d-flex m-0 col-3" method="post">
                        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="searchServices">
                        <button class="btn btn-outline-success" type="submit" name="searchServices">Search</button>
                    </form>
                </div>
            </div>
        </div>
